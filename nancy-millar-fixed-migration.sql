-- The Nancy Millar Trophy Migration - FIXED VERSION
-- Run this in Supabase SQL Editor

-- 1. Insert The Nancy Millar Trophy tournament (using patrons_cup format)
INSERT INTO tournaments (
  ...
  '{
    ...
    "entryFee": 2500,
    "ballPoolFee": 200,
    "tournamentType": "foursomes_stableford",
    "strokeIndex": {
      "1": {"par": 4, "si": 15},
      "2": {"par": 5, "si": 7},
      "3": {"par": 5, "si": 9},
...
-- 2. Verify the tournament was created
SELECT id, name, slug, format, status FROM tournaments WHERE slug = 'nancy-millar-trophy-2025';
