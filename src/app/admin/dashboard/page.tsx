...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    // Get official role from localStorage
    const role = localStorage.getItem('tournament-official-role') || '';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">Tournament Official Dashboard</h1>
                <p className="text-sm text-gray-600">
                  Welcome, {formatRole(officialRole)}
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">View current standings</div>
                </div>
              </Link>
            </div>
          </div>
