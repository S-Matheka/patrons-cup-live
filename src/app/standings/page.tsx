  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900">Tournament Standings</h1>
        <p className="text-lg text-gray-600">Current rankings and performance statistics</p>
      </div>
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {sortedScores(plateScores).map((score, index) => (
                        <tr key={score.teamId} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{index + 1}</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
