-- Trigger-Safe Multi-Tournament Migration
-- Copy and paste this entire script into your Supabase SQL Editor and run it

-- 1. Create tournaments table (with updated_at to satisfy triggers)
...
-- 6. Add foreign key constraints (simplified approach)
DO $$ 
BEGIN
...
-- 8. Handle unique constraints properly
...
-- 9. Insert sample tournaments for testing
INSERT INTO tournaments (name, slug, description, start_date, end_date, status, format) 
VALUES 
  (
    'Patrons Cup 2024', 
